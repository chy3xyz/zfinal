...
[![Version](https://img.shields.io/badge/version-v0.20.13-blue.svg)](CHANGELOG.md)
...
```bash
zig fetch --save https://github.com/chy3xyz/zfinal/archive/refs/tags/v0.20.13.tar.gz
```
...
.dependencies = .{
    .zfinal = .{
        .url = "https://github.com/chy3xyz/zfinal/archive/refs/tags/v0.20.13.tar.gz",
...
**ZFinal v0.20.13** — Zig 的 AI 极速开发框架
