...
[![Version](https://img.shields.io/badge/version-v0.20.15-blue.svg)](CHANGELOG.md)
...
```bash
zig fetch --save https://github.com/chy3xyz/zfinal/archive/refs/tags/v0.20.15.tar.gz
```
...
.dependencies = .{
    .zfinal = .{
        .url = "https://github.com/chy3xyz/zfinal/archive/refs/tags/v0.20.15.tar.gz",
...
| AgentPlugin (in-process MCP-style) | ✅ Stable | JSON-RPC tools / resources / prompts router |
| AI MCP client (`McpClient`/`McpBridge`) | ✅ Stable | stdio + HTTP/SSE → SkillRegistry ([doc/ai.md](doc/ai.md)) |
...
**ZFinal v0.20.15** — Zig 的 AI 极速开发框架
