...
pub fn generateIntegrationTest(allocator: std.mem.Allocator, table: *const Table, module_name: []const u8) ![]const u8 {
    ...
    return std.fmt.allocPrint(allocator,
        \\// @generated by zf crud:sql — integration test
...
pub fn generateService(allocator: std.mem.Allocator, table: *const Table) ![]const u8 {
    ...
    return std.fmt.allocPrint(allocator,
        \\// @generated by zf crud:sql — DO NOT EDIT
        \\// Regenerate: zf crud:sql <schema.sql>
        \\const std = @import("std");
        \\const zfinal = @import("zfinal");
        ...
        \\
        \\/// Paginated list.
        \\pub fn paginate(db: *zfinal.DB, page: u32, size: u32, allocator: std.mem.Allocator) !zfinal.Page(Data) {{
        \\    return {s}Model.paginate(db, page, size, allocator);
        \\}}
        \\
        \\/// Total row count.
        \\pub fn count(db: *zfinal.DB) !u64 {{
