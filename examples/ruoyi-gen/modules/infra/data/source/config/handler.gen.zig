...
/// List InfraDataSourceConfig records with pagination + rate limiting.
...
/// Show InfraDataSourceConfig by ID.
...
/// Create InfraDataSourceConfig record (CSRF-protected).
...
/// Update InfraDataSourceConfig record (CSRF-protected).
...
/// Delete InfraDataSourceConfig record (CSRF-protected).
...
/// Partial update InfraDataSourceConfig record (CSRF-protected, PATCH).
