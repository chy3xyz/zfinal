...
/// List SystemNotice records with pagination + rate limiting.
...
/// Create SystemNotice record (CSRF-protected).
...
/// Update SystemNotice record (CSRF-protected).
...
/// Delete SystemNotice record (CSRF-protected).
...
/// Partial update SystemNotice record (CSRF-protected, PATCH).
