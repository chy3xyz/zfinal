...
/// SystemMailTemplate model — maps to `system_mail_template` table.
pub const SystemMailTemplate = struct {
    id: ?i64 = null,
    name: []const u8,
    code: []const u8,
    account_id: i64,
...
pub const SystemMailTemplateModel = zfinal.Model(SystemMailTemplate, "system_mail_template");
...
pub fn validate(data: SystemMailTemplate) !void {
