...
/// List SystemSmsTemplate records with pagination + rate limiting.
...
/// Create SystemSmsTemplate record (CSRF-protected).
...
/// Update SystemSmsTemplate record (CSRF-protected).
...
/// Delete SystemSmsTemplate record (CSRF-protected).
...
/// Partial update SystemSmsTemplate record (CSRF-protected, PATCH).
