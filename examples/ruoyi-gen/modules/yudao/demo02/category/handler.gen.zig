...
/// List YudaoDemo02Category records with pagination + rate limiting.
...
/// Show YudaoDemo02Category by ID.
...
/// Create YudaoDemo02Category record (CSRF-protected).
...
/// Update YudaoDemo02Category record (CSRF-protected).
...
/// Delete YudaoDemo02Category record (CSRF-protected).
...
/// Partial update YudaoDemo02Category record (CSRF-protected, PATCH).
