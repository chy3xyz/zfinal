...
/// YudaoDemo02Category model — maps to `yudao_demo02_category` table.
pub const YudaoDemo02Category = struct {
    id: ?i64 = null,
    name: []const u8,
    parent_id: i64,
...
pub const YudaoDemo02CategoryModel = zfinal.Model(YudaoDemo02Category, "yudao_demo02_category");
...
/// Validate YudaoDemo02Category data before insert/update.
pub fn validate(data: YudaoDemo02Category) !void {
