...
/// YudaoDemo03Course model — maps to `yudao_demo03_course` table.
pub const YudaoDemo03Course = struct {
    id: ?i64 = null,
    student_id: i64,
    name: []const u8,
    score: i64,
...
pub const YudaoDemo03CourseModel = zfinal.Model(YudaoDemo03Course, "yudao_demo03_course");
...
/// Validate YudaoDemo03Course data before insert/update.
pub fn validate(data: YudaoDemo03Course) !void {
