...
/// List YudaoDemo03Grade records with pagination + rate limiting.
...
/// Create YudaoDemo03Grade record (CSRF-protected).
pub fn create(ctx: *zfinal.Context) !void {
    ...
    const data: service.Data = .{
        ...
        .teacher = (try ctx.getPara("teacher")) orelse "",
...
/// Update YudaoDemo03Grade record (CSRF-protected).
pub fn update(ctx: *zfinal.Context) !void {
    ...
    if (try ctx.getPara("teacher")) |v| item.data.teacher = v;
...
/// Delete YudaoDemo03Grade record (CSRF-protected).
...
/// Partial update YudaoDemo03Grade record (CSRF-protected, PATCH).
