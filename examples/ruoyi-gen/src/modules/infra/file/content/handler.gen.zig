...
/// List InfraFileContent records with pagination + rate limiting.
...
/// Create InfraFileContent record (CSRF-protected).
...
/// Update InfraFileContent record (CSRF-protected).
...
/// Delete InfraFileContent record (CSRF-protected).
...
/// Partial update InfraFileContent record (CSRF-protected, PATCH).
