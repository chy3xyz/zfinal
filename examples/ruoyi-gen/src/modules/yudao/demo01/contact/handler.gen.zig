...
/// List YudaoDemo01Contact records with pagination + rate limiting.
...
/// Create YudaoDemo01Contact record (CSRF-protected).
...
/// Update YudaoDemo01Contact record (CSRF-protected).
...
/// Delete YudaoDemo01Contact record (CSRF-protected).
...
/// Partial update YudaoDemo01Contact record (CSRF-protected, PATCH).
