...
/// List SystemRoleMenu records with pagination + rate limiting.
...
/// Create SystemRoleMenu record (CSRF-protected).
pub fn create(ctx: *zfinal.Context) !void {
    ...
    const data: service.Data = .{
        ...
        .menu_id = std.fmt.parseInt(i64, (try ctx.getPara("menu_id")) orelse "0", 10) catch 0,
...
/// Update SystemRoleMenu record (CSRF-protected).
pub fn update(ctx: *zfinal.Context) !void {
    ...
    if (try ctx.getPara("menu_id")) |v| item.data.menu_id = std.fmt.parseInt(i64, v, 10) catch item.data.menu_id;
...
/// Delete SystemRoleMenu record (CSRF-protected).
...
/// Partial update SystemRoleMenu record (CSRF-protected, PATCH).
