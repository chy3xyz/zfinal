...
/// List SystemNotifyTemplate records with pagination + rate limiting.
...
/// Show SystemNotifyTemplate by ID.
...
/// Create SystemNotifyTemplate record (CSRF-protected).
pub fn create(ctx: *zfinal.Context) !void {
    ...
    const data: service.Data = .{
            ...
            .params = (try ctx.getPara("params")) orelse null,
...
/// Update SystemNotifyTemplate record (CSRF-protected).
...
/// Delete SystemNotifyTemplate record (CSRF-protected).
...
/// Partial update SystemNotifyTemplate record (CSRF-protected, PATCH).
