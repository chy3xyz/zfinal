...
/// List SystemPost records with pagination + rate limiting.
...
/// Create SystemPost record (CSRF-protected).
...
/// Update SystemPost record (CSRF-protected).
...
/// Delete SystemPost record (CSRF-protected).
...
/// Partial update SystemPost record (CSRF-protected, PATCH).
