...
/// List SystemTenantPackage records with pagination + rate limiting.
...
/// Show SystemTenantPackage by ID.
...
/// Create SystemTenantPackage record (CSRF-protected).
pub fn create(ctx: *zfinal.Context) !void {
    ...
    const data: service.Data = .{
        ...
        .menu_ids = (try ctx.getPara("menu_ids")) orelse "",
...
/// Update SystemTenantPackage record (CSRF-protected).
pub fn update(ctx: *zfinal.Context) !void {
    ...
    if (try ctx.getPara("menu_ids")) |v| item.data.menu_ids = v;
...
/// Delete SystemTenantPackage record (CSRF-protected).
...
/// Partial update SystemTenantPackage record (CSRF-protected, PATCH).
