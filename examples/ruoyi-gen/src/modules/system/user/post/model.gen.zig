...
/// SystemUserPost model — maps to `system_user_post` table.
pub const SystemUserPost = struct {
    id: ?i64 = null,
    user_id: i64,
    post_id: i64,
...
pub const SystemUserPostModel = zfinal.Model(SystemUserPost, "system_user_post");
...
/// Validate SystemUserPost data before insert/update.
pub fn validate(data: SystemUserPost) !void {
