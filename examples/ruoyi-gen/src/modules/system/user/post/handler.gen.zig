...
/// List SystemUserPost records with pagination + rate limiting.
...
/// Create SystemUserPost record (CSRF-protected).
...
/// Update SystemUserPost record (CSRF-protected).
...
/// Delete SystemUserPost record (CSRF-protected).
...
/// Partial update SystemUserPost record (CSRF-protected, PATCH).
