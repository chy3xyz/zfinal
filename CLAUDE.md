...
- `zig build test` runs unit tests; expected baseline is `369 passed; 14 skipped; 0 failed.`
  (3 extra skips when `NATS_URL` / `ROBUSTMQ_URL` unset — CI `messaging-live` enables them.)
